...
def get_params(region_id='R1', 
               data_path=os.path.join(os.getcwd(), '/content/weather_colab/train/utils/data'),
               splits_path=os.path.join(os.getcwd()),
               static_data_path=os.path.join(os.getcwd(), '/content/weather_colab/train/utils/data/static'),
               size=256,
               collapse_time=False):
    ...
    data_params['static_paths']['l'] = '/content/weather_colab/train/utils/data/static/Navigation_of_S_NWC_CT_MSG4_Europe-VISIR_20201106T120000Z.nc'
    data_params['static_paths']['e'] = '/content/weather_colab/train/utils/data/static/S_NWC_TOPO_MSG4_+000.0_Europe-VISIR.raw'

    data_params['train_splits'] = '/content/weather_colab/train/utils/trainsplits.csv'
    data_params['test_splits'] ='/content/weather_colab/train/utils/test_split.json'
    data_params['black_list_path'] = '/content/weather_colab/train/utils/blacklist.json'
    ...
    data_params['len_seq_out'] = 32 # time-bins
    ...
    model_params['n_classes'] = data_params['bins_to_predict'] * len(data_params['target_vars'])
    ...
    training_params['n_workers'] = 4
    training_params['warmup'] = 5
    training_params['lr'] = 1e-3
    training_params['scheduler'] = 'CAR' # '' no scheduler, 'LW' Linear warmup, 'CA' CosineAnnealingLR, 'CAR' CosineAnnealingLR_with_restart
